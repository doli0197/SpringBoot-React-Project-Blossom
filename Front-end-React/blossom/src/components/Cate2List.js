...
class Cate2List extends Component {
    ...
    constructor(props){
        ...
        this.state = {
            ...
            proNews : [],
            proTags : [],
            cate2 : this.props.match.params.cate2
        }
    }
    ...
    loadItem = () => { //★setState에서 []아닌가. 배열이라 여러개니
            axios.get(`http://localhost:8080/cate2/${this.state.cate2}`)
            .then(res=>{
